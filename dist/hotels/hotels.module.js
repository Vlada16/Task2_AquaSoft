...
let HotelsModule = class HotelsModule {
    configure(consumer) {
        consumer
            .apply(auth_middleware_1.authenticate)
            .forRoutes({ path: 'hotels', method: common_1.RequestMethod.POST });
    }
};
HotelsModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([hotel_model_1.Hotel])],
